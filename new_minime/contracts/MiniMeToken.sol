...
contract TokenController {
   ...
   function onBurn(address _owner, uint _amount) returns(bool);
}
...
///////////////////
   ...
   function transferFrom(address _from, address _to, uint256 _amount
       ...
       if (msg.sender != controller) {
           ...
           // The standard ERC20 transferFrom functionality with unlimited allowance
...
////////////////
   ...
   function totalPledgedFees() constant returns (uint) {
   ...
   function totalPledgedFeesAt(uint _blockNumber) constant returns(uint) {
...
////////////////
   ...
   function pledgeFees(uint _value) onlyController returns (bool) {
